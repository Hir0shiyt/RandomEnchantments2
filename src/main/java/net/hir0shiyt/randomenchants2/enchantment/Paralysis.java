...
public class Paralysis extends Enchantment {
    ...
    public boolean canEnchant(ItemStack stack) {
        return ModConfig.paralysisConfig.isEnabled.get() && this.canApplyAtEnchantingTable(stack);
    }

    @Override
    public boolean canApplyAtEnchantingTable(ItemStack stack) {
        if (stack.getItem() instanceof SwordItem || stack.getItem() instanceof BowItem || stack.getItem() instanceof CrossbowItem) {
            return ModConfig.paralysisConfig.isEnabled.get();
        } else {
            return false;
        }
    }
    ...
    public boolean isTradeable() {
        return ModConfig.paralysisConfig.isEnabled.get() && ModConfig.paralysisConfig.isTradeable.get();
    }

    @Override
    public boolean isTreasureOnly() {
        return ModConfig.paralysisConfig.isEnabled.get() && ModConfig.paralysisConfig.isTreasureOnly.get();
    }
