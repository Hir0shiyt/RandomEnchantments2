...
public class CursedJumping extends Enchantment {
    public CursedJumping(Rarity rarity, EnchantmentCategory category, EquipmentSlot[] slots) {
    ...
    public static void onArrowImpact(ProjectileImpactEvent event) {
        ...
        if (arrow instanceof ThrowableProjectile || arrow instanceof FishingHook || arrow instanceof ThrownTrident || arrow instanceof FireworkRocketEntity || arrow instanceof Fireball || arrow instanceof DragonFireball) {return;}
